...
public class OrderAdapter extends FirebaseRecyclerAdapter<OrderModel, OrderAdapter.ViewHolder> {
    ...
    public OrderAdapter(@NonNull FirebaseRecyclerOptions<OrderModel> options, String dateStamp) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull OrderModel model) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (getItemCount() == 0) {
                    Toast.makeText(context, "No Active Orders", Toast.LENGTH_SHORT).show();
                } else {
                    if (snapshot.exists()) {
    ...
    void showDialog(String dateStamp, String orderID, String phoneNumber) {
        ...
        updateStore.put("orderStatus", "Prepared");
    ...
    private void sendMessage(String phoneNumber, String orderID) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED) {
            ...
            smsManager.sendTextMessage(phoneNumber, null, "Your Order with Order ID : " + orderID + " has been Prepared and ready for takeaway." + "\nregards,\nCafesio", null, null);
        } else {
